...
VALUES
  ($1, $2, $3, $4, $5) RETURNING id, name, address, city, coordinate, phone, logo, created_at
`
...
SELECT
  id, name, address, city, coordinate, phone, logo, created_at
FROM
  masjids
WHERE
  id = $1
...
SET
  ...
  logo = $6
WHERE
  id = $1 RETURNING id, name, address, city, coordinate, phone, logo, created_at
`
