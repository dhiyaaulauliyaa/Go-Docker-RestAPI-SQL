...
VALUES
  ($1, $2, $3, $4) RETURNING id, name, venue, community, masjid, date, created_at
`
...
SELECT
  id, name, venue, community, masjid, date, created_at
FROM
  events
WHERE
  id = $1
...
SET
  ...
  date = $5
WHERE
  id = $1 RETURNING id, name, venue, community, masjid, date, created_at
`
